"""Definitions for the `Neutrinosphere1` class."""
import numpy as np
...
class Neutrinosphere1(Energetic):
    ...
    def __init__(self, **kwargs):
        """Initialize module."""
        super(Neutrinosphere1, self).__init__(**kwargs)
    ...
    def process(self, **kwargs):
        ...
        mass_weight = 1. - shock_mass_fraction
        Ye = self.getYe(self._vcoast,0,2.5e-6)
